...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/e3885ed339aaa8b4fdf4a4380416c8d70b6929ef/fs-extra-promise/index.d.ts
...
export function copyAsync(src: string, dest: string, filter: CopyFilter): Promise<void>;
export function copyAsync(src: string, dest: string, options: CopyOptions): Promise<void>;
