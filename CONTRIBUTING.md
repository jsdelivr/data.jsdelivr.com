...
To get started, you need to have Node.js 22 or 24 and Docker Compose; run `docker compose up -d --build --wait` to start MariaDB 11.8+ with the LZ4 provider and Redis.
