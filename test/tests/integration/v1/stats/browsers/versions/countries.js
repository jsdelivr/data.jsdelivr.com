...
import { makePaginatedEndpointAssertions, makeEndpointSnapshotTests, makeEndpointPaginationTests, setupSnapshots } from '../../../../../../utils.js';

describe('/v1/stats/browsers/versions/countries', () => {
	before(() => {
...
function makeStatsBrowsersVersionTests () {
	makePaginatedEndpointAssertions('/v1/stats/browsers/browser%2019/versions/2/countries{?continent,period}', {}, [
		{
	...
	makeEndpointPaginationTests('/v1/stats/browsers/browser%2019/versions/2/countries', { period: '2020-04' });

	makeEndpointSnapshotTests('/v1/stats/browsers/browser%2019/versions/2/countries{?continent,period}', {}, [
		{ continent: 'X' },
		{ period: 'month' },
	], { status: 400 });
}
