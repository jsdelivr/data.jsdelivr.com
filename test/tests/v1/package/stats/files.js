...
function makePackageStatsTests () {
	...
	makeEndpointPaginationTests('/v1/package/npm/package-59@1.1.0/stats/files', { by: 'hits' });
	makeEndpointPaginationTests('/v1/package/gh/user/package-59@1.1.0/stats/files', { by: 'hits' });
}
